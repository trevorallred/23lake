...
export const buildingData: BuildingData = {
  ...
  rooms: [
    { name: '1', fontSize: 'lg', color: color(), dimensions: { left: 276, top: 236, bottom: 290, right: 326 } },
    { name: '2', fontSize: 'lg', color: color(), dimensions: { left: 276, top: 197, bottom: 236, right: 326 } },
    ...
    { name: '4', fontSize: 'lg', color: color(), dimensions: { left: 150, top: 72, bottom: 121, right: 200 } },
    { name: '5', fontSize: 'lg', color: color(), dimensions: { left: 220, top: 72, bottom: 121, right: 259 } },
    { name: '6', fontSize: 'lg', color: color(), dimensions: { left: 259, top: 72, bottom: 121, right: 297 } },
    ...
    { name: 'Oceanside Kitchen', color: color(), dimensions: { left: 674, top: 269, bottom: 343, right: 735 } },
    ...
    { name: '20/21', fontSize: 'lg', color: color(), dimensions: { left: 836, top: 72, bottom: 123, right: 915 } },
    ...
    { name: 'Stake Pres', color: color(), dimensions: { left: 226, top: 718, bottom: 771, right: 276 } },
    { name: 'Stake Lib', color: color(), dimensions: { left: 276, top: 730, bottom: 771, right: 326 } },
    { name: 'Stake Clerk', color: color(), dimensions: { left: 259, top: 796, bottom: 849, right: 294 } },
    { name: 'Stake Office', color: color(), dimensions: { left: 294, top: 796, bottom: 849, right: 326 } },
    ...
    { name: 'Creekside Relief Society', color: color(), dimensions: { left: 588, top: 666, bottom: 778, right: 697 } },
    { name: '37/38', color: color(), dimensions: { left: 570, top: 535, bottom: 642, right: 650 } },
    { name: 'Creekside Kitchen', color: color(), dimensions: { left: 674, top: 567, bottom: 642, right: 735 } },
    {
    ...
    { name: 'Creekside Library', color: color(), dimensions: { left: 792, top: 798, bottom: 849, right: 854 } },
    ...
    { name: 'Bishop West Park', color: color(), dimensions: { left: 934, top: 718, bottom: 775, right: 1019 } },
